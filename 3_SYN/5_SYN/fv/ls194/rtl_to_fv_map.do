...
# Generated on: Thu Jul 09 06:00:49 KST 2026 (Wed Jul 08 21:00:49 UTC 2026)
...
set logfile fv/ls194/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/ls194 -revised fv_map
...
add_search_path ../../4_SAMPLE_RTL -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../../4_SAMPLE_RTL/ls194.v
elaborate_design -golden -root {ls194} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/ls194/fv_map.v.gz
elaborate_design -revised -root {ls194}
...
#add_name_alias fv/ls194/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.ls194.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.ls194.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.ls194.rtl.fv_map.rpt
