...
# Generated on: Wed Jul 08 06:20:25 KST 2026 (Tue Jul 07 21:20:25 UTC 2026)
...
set logfile fv/bcd_to_7seg/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/bcd_to_7seg -revised fv_map
...
add_search_path /home/hah003/Basic_SoC_implementation/1_RTL/4_COMB_LOGIC/3_DECODER/bcd_to_7seg.v -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/hah003/Basic_SoC_implementation/1_RTL/4_COMB_LOGIC/3_DECODER/bcd_to_7seg.v
elaborate_design -golden -root {bcd_to_7seg} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/bcd_to_7seg/fv_map.v.gz
elaborate_design -revised -root {bcd_to_7seg}
...
set_system_mode lec
write_compared_points noneq.compared_points.bcd_to_7seg.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.bcd_to_7seg.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.bcd_to_7seg.rtl.fv_map.rpt
